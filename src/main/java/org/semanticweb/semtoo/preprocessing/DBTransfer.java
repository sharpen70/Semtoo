...
public class DBTransfer {
	...
	public void loadDBfiletoGraphDB(String clsAssertioncsv, String pptAssertincsv) throws IOException {
		...
		String cypher1 = "USING PERIODIC COMMIT"
		...
		String cypher2 = "USING PERIODIC COMMIT"
		...
		String cypher2_1 = "USING PERIODIC COMMIT"
				+ " LOAD CSV WITH HEADERS FROM \"file:///" + pptAssertincsv + "\" AS ppta"
		...
		String cypher3 = "USING PERIODIC COMMIT"
				+ " LOAD CSV WITH HEADERS FROM \"file:///" + pptAssertincsv + "\" AS ppta"
		...
		String cypher3_2 = "USING PERIODIC COMMIT"
				+ " LOAD CSV WITH HEADERS FROM \"file:///" + pptAssertincsv + "\" AS ppta"
		...
		String cypher3_1 = "USING PERIODIC COMMIT"
				+ " LOAD CSV WITH HEADERS FROM \"file:///" + pptAssertincsv + "\" AS ppta"
